      ...
      <div className="max-w-[1120px] mx-auto flex flex-col md:flex-row-reverse items-center justify-between mt-4 px-4">
        ...
        <div className="w-full md:w-1/2 text-gray-800 px-4">
          ...
          <p className="text-justify pt-5 text-base md:text-justify">
            ...
            resources, or app hosting, we ensure your systems are optimized for
            top performance, high availability, and cost efficiency. Our team
            helps you take full advantage of the cloud to support your business
      ...
      <div className="max-w-[1120px] mx-auto flex flex-col md:flex-row-reverse items-center justify-between mt-4 px-4">
        ...
        <div className="w-full md:w-1/2 text-gray-800 px-4">
          ...
          <p className="text-justify text-base pt-5 md:text-justify">
            ...
            increases conversion rates, helping your business grow effectively.
          </p>
        </div>
      </div>
    </>
