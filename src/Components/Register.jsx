  ...
  function CareerForm() {
    ...
    const handleSubmit = async (e) => {
      ...
      if (Object.keys(validationErrors).length === 0) {
        ...
        try {
          const response = await fetch("https://hooks.zapier.com/hooks/catch/21068256/28zanvj/", {
            method: "POST",
            body: JSON.stringify({
          ...
          if (response.ok) {
            setShowPopup(true);
            setPopupMessage("Congratulations Your Registration with Invextech is Successful! You will get an email shortly. Thank You For Applying.😊🤩");
            setIsSubmitted(true);
            setFormData({
              fullName: "",
              email: "",
